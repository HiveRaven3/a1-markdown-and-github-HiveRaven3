...
# Feel free to add comments using the hash signs '#'
...
# Clone your private assignment repository from GitHub to your machineg
git clone https://github.com/info201b-sp21/a1-markdown-and-github-HiveRaven3.git

# Change your directory to inside of your "a1-news-USERNAME" folder
ls
cd \a1-markdown-and-github-HiveRaven3
